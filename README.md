...
1. 정보 격차 해소
현재 전기차 화재에 대한 정보는 단편적인 사고 보도나 제조사의 일방적 홍보 자료에 의존하고 있어, 중립적이고 종합적인 비교 분석 자료가 부족한 상황이다.
2. 사회적 인식 개선
전기차 화재 사고의 선별적 보도로 인해 실제 위험도보다 과장된 불안감이 형성되어 있으며, 이는 친환경 교통수단 보급에 장애 요인으로 작용하고 있다.
3. 합리적 의사결정 지원
소비자들이 차량 구매 시 안전성을 고려할 때 감정적 판단이 아닌 통계적 근거에 기반한 선택을 할 수 있도록 돕는 신뢰성 있는 정보 제공이 시급하다.

-  **프로젝트 목표**
  > 전기차와 내연기관차의 화재 발생률을 정량적으로 분석하고 시각화하여, 데이터 기반의 객관적 비교 정보를 제공함으로써 전기차 안전성에 대한 과학적 근거를 마련한다. 또한 각 차종별 화재 특성과 안전 관리 방법을 정리한 실용적인 FAQ 시스템을 구축하여 소비자가 신뢰할 수 있는 정보에 쉽게 접근할 수 있도록 한다.

- 📖 **레퍼런스**
  - 국토교통부, 소방청 화재 통계
  - 기아자동차, 테슬라, 쉐보레 EV FAQ
