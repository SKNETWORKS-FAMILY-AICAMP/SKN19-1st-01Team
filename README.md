...
## 🔍 수집 데이터
- **소방청** : 차량 화재 통계
- **국토교통부/한국전력공사** : 전기차 보급 현황 및 전기차 제조사
...
> .
- **임상민**
> 짧은 기간 안에 크롤링으로 데이터를 수집하고 이를 문서로 정리하며 프로젝트의 기반을 마련할 수 있었고 Streamlit 대시보드를 구현하면서 분석 결과를 시각적으로 표현하는 경험을 얻었으며 다음 프로젝트에서는 더 깔끔한 코드 관리와 시각화 디자인 완성도를 높이고 싶다.
